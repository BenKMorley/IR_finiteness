...
def get_statistical_errors_central_fit():
  ...
  g = 0.1
  m_c1 = mPT_1loop(g, N) + g ** 2 * (params_central[0] - params_central[-2] * K1(g, N))
  print(f"m_c1 = {m_c1}")
...
def get_systematic_errors():
  ...
  results_N2 = [params_central, sys_sigmas, m_c, m_c_error]
  ...
  results_N4 = [params_central, sys_sigmas, m_c1, m_c1_error, m_c2, m_c2_error]
...
def get_Bayes_factors():
  ...
  Bayes_factors4 = Bayes_factors4 / numpy.log(10)
  Bayes_factors2 = Bayes_factors2 / numpy.log(10)
