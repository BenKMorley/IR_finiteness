...
#     for j, GL_min in enumerate(GL_mins):
#       pvalues[i, j], params[i, j], dofs[i, j] = run_frequentist_analysis(h5_data_file, model, N, Bbar_1, Bbar_2, GL_min, GL_max, param_names, x0, run_bootstrap=False, print_info=False)
